...
// DoReq executes the HTTP request and decodes the response into the provided data structure.
// It also handles error responses by wrapping them in a custom error type.
